    ...
    <div wire:ignore.self class="modal fade" id="uploadContactModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form wire:submit.prevent="uploadContact" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        ...
                        @if($rows)
                            ...
                            <div class="mb-5">
                                <table class="table">
                                    ...
                                    @foreach($rows[0] as $key => $column)
                                        <tr>
                                            <td>{{ $column }}</td>
                                            <td>
                                                <select class="form-select" wire:model="newColumnValues. {{ $key }}">
                                ...
                                <button type="button" class="btn btn-primary" wire:click="saveDataFromFileToDB">Import Data</button>
                            </div>
